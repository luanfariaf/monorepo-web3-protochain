...
export default class Block {
     ...
     */
    isValid(previousHash: string, previousIndex: number, difficulty: number, feePeerTx: number): Validation {
        ...
        if (this.transactions && this.transactions.length) {
            ...
            // TODO: Add amount tax validation
            const totalFees = feePeerTx * this.transactions.filter(tx => tx.type !== TransactionType.FEE).length;
